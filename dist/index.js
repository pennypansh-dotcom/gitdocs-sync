...
module.exports.FAILSAFE_SCHEMA = __nccwpck_require__(451)
...
module.exports = (__nccwpck_require__(451).extend)({
  implicit: [
...
const { existsSync, mkdirSync, readdirSync, readFileSync, statSync, writeFileSync } = __nccwpck_require__(24);
const { createHash } = __nccwpck_require__(598);
const { recordUsage } = __nccwpck_require__(614);
...
function hashContent(content) {
  return (__nccwpck_require__(598).createHash)("sha256").update(content).digest("hex");
}
...
const { appendFileSync, mkdirSync } = __nccwpck_require__(24);
